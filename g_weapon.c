...
void fire_mirv_rocket(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage)
{
	edict_t	*rocket;
	...
	rocket->owner = self;
	rocket->touch = rocket_touch;
	rocket->nextthink = level.time + 500 / speed;
	rocket->think = rocket_mirv_think;
	rocket->dmg = damage;
	rocket->radius_dmg = radius_damage;
	rocket->dmg_radius = damage_radius;
	rocket->s.sound = gi.soundindex("weapons/rockfly.wav");
...
void redeemer_think(edict_t *ent)
{
	...
	VectorCopy(ent->s.angles, ent->owner->client->v_angle);
...
void fire_redeemer(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage)
{
	edict_t	*rocket;
...
void fire_trail_rocket(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage)
{
	edict_t	*rocket;
	...
	rocket->think = trail_rocket_think;
	rocket->dmg = damage;
	rocket->radius_dmg = radius_damage;
	rocket->dmg_radius = damage_radius;
	rocket->s.sound = gi.soundindex("weapons/rockfly.wav");
...
void fire_wall_rocket(edict_t *self, vec3_t start, vec3_t dir, int damage, int speed, float damage_radius, int radius_damage)
{
	edict_t	*rocket;
	...
	rocket->owner = self;
	rocket->touch = rocket_touch;
	rocket->nextthink = level.time + 3.0;
	rocket->think = wall_rocket_think;
	rocket->dmg = damage;
	rocket->radius_dmg = radius_damage;
	rocket->dmg_radius = damage_radius;
	rocket->s.sound = gi.soundindex("weapons/rockfly.wav");
